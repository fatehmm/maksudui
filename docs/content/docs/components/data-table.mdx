...
<Steps>
  <Step>
    ...
    ```package-install
    npx shadcn@2.4.0-canary.12 add "https://maksud.dev/r/data-table"
    ```
  </Step>
  <Step>
...
```package-install
npx shadcn@2.4.0-canary.12 add "https://maksud.dev/r/data-table-sort-list"
```
...
```package-install
npx shadcn@2.4.0-canary.12 add "https://maksud.dev/r/data-table-filter-list"
```
...
```package-install
npx shadcn@2.4.0-canary.12 add "https://maksud.dev/r/data-table-filter-menu"
```
...
```package-install
npx shadcn@2.4.0-canary.12 add "https://maksud.dev/r/data-table-action-bar"
```
