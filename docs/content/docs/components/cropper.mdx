...
```package-install
npx shadcn@latest add "https://maksud.dev/r/cropper"
...
A cropper integrated with the [FileUpload](https://maksud.dev/docs/components/file-upload) component for uploading and cropping images.
