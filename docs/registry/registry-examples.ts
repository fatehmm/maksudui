...
export const examples: Registry['items'] = [
  ...
  },
  {
    ...
    files: [
      {
        path: 'examples/alert-dismissible-demo.tsx',
        type: 'registry:example',
      },
    ],
  },
  {
    ...
    files: [
      {
        path: 'examples/alert-with-actions-demo.tsx',
        type: 'registry:example',
      },
    ],
  },
  {
    ...
    files: [
      {
        path: 'examples/alert-variants-demo.tsx',
        type: 'registry:example',
      },
    ],
  },
  ...
  },
  {
    ...
    files: [
      {
        path: 'examples/button-with-icons-demo.tsx',
        type: 'registry:example',
      },
    ],
  },
  ...
  },
  {
    ...
    type: 'registry:example',
    dependencies: ['class-variance-authority', '@hookform/resolvers', 'react-hook-form', 'zod'],
